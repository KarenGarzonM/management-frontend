...
const PositionFormModal = ({ show, handleClose, positionData, onSuccess, mode }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (mode === 'create') {
                //CREATE NEW POSITION
                await axios.post('http://localhost:8080/api/positions/', form, config);
                ...
                await axios.put(`http://localhost:8080/api/positions/${positionData.positionId}`, changedFields, config);
